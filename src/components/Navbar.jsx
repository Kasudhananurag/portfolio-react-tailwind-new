...
const Navbar = () => {
    ...
    return (
        <div className='fixed font-bold shadow-lg text-white w-full h-[80px] flex justify-between items-center px-5 bg-black ' >
            <div>
            ...
            <div className=" hidden md:flex fixed flex-col bg-gray-600 hover:bg-black top-[35%] left-0 ">
                <ul>
