...
const Skills = () => {
  return (
    <div name='skills' className='w-full upr h-screen bg-black'>
      <div className=' max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full '>
        <div className=" text-slate-300  " >
          <p className='text-4xl font-bold py-4 '><span className='border-b-4 border-pink-500'>Worked with</span></p>
          <p>These are the technologies I have worked with</p>
        </div>
        <div className='w-full grid text-slate-200 grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
